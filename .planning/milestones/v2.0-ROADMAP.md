...
- [x] **Phase 5: Design Token Foundation** - Palette swap to DeepBlack/Orange/White OKLCH, Montserrat variable font, full shadcn token expansion, 27-usage accent audit, skip-link rewrite
- [x] **Phase 6: Content Sections Rebuild** - Rebuilt Hero (brief copy + 3 metrics + View My Work CTA), rewritten About, new Value Prop section, redesigned Contact
- [x] **Phase 7: Case Studies** - Two 5-block case studies (UTD International Center + Rio Jiu Jitsu) via shared Data-as-Prop CaseStudySection component
- [x] **Phase 8: Creative Work Gallery** - 31-asset gallery across 6 categories with accessible lightbox, next/image pipeline, aspect-ratio containers, lazy loading
- [x] **Phase 9: Navigation Rewire + Retirements** - Rewire navbar anchors, reorder page.tsx, delete v1.0 Experience/Skills/Leadership sections atomically
- [x] **Phase 10: Polish, Accessibility QA, Deploy** - Contrast re-audit, LCP verification, OG image rename, Twitter card, reduced-motion JS verification, production deploy
